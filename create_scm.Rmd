...
```{r}
#net_str <- "[is_recid|age:juv_fel_count:juv_misd_count:priors_count:c_charge_degree][c_charge_degree|race:sex][age][juv_fel_count][juv_misd_count][priors_count][race][sex]"
# net_str <- "[two_year_recid|race:prior_adult_counts:c_charge_degree]"
# net <- model2network(net_str)
# graphviz.plot(net)
